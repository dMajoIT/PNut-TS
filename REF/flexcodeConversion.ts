...
this.flexcodeValues.set(eFlexcodes.fc_pinread, flexcodeValue(eByteCodes.bc_pinread, 1, 1, 1, 1));
this.flexcodeValues.set(eFlexcodes.fc_pinwrite, flexcodeValue(eByteCodes.bc_pinwrite, 2, 0, 1, 1));
this.flexcodeValues.set(eFlexcodes.fc_pinstart, flexcodeValue(eByteCodes.bc_pinstart, 4, 0, 1, 1));
this.flexcodeValues.set(eFlexcodes.fc_pinclear, flexcodeValue(eByteCodes.bc_pinclear, 1, 0, 1, 1));
...
this.flexcodeValues.set(eFlexcodes.fc_byteswap, flexcodeValue(eByteCodes.bc_byteswap, 3, 0, 0, 1));
this.flexcodeValues.set(eFlexcodes.fc_bytecomp, flexcodeValue(eByteCodes.bc_bytecomp, 3, 1, 0, 1));
...
this.flexcodeValues.set(eFlexcodes.fc_wordswap, flexcodeValue(eByteCodes.bc_wordswap, 3, 0, 0, 1));
this.flexcodeValues.set(eFlexcodes.fc_wordcomp, flexcodeValue(eByteCodes.bc_wordcomp, 3, 1, 0, 1));
...
this.flexcodeValues.set(eFlexcodes.fc_longswap, flexcodeValue(eByteCodes.bc_longswap, 3, 0, 0, 1));
this.flexcodeValues.set(eFlexcodes.fc_longcomp, flexcodeValue(eByteCodes.bc_longcomp, 3, 1, 0, 1));
...
this.flexcodeValues.set(eFlexcodes.fc_tasknext, flexcodeValue(eByteCodes.bc_tasknext, 0, 0, 0, 0));
this.flexcodeValues.set(eFlexcodes.fc_taskstop, flexcodeValue(eByteCodes.bc_taskstop, 1, 0, 0, 1));
this.flexcodeValues.set(eFlexcodes.fc_taskhalt, flexcodeValue(eByteCodes.bc_taskhalt, 1, 0, 0, 1));
this.flexcodeValues.set(eFlexcodes.fc_taskcont, flexcodeValue(eByteCodes.bc_taskcont, 1, 0, 0, 1));
this.flexcodeValues.set(eFlexcodes.fc_taskchk, flexcodeValue(eByteCodes.bc_taskchk, 1, 1, 0, 1));
this.flexcodeValues.set(eFlexcodes.fc_taskid, flexcodeValue(eByteCodes.bc_taskid, 0, 1, 0, 1));
